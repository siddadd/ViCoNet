...
%%% Every aisle is run independently and context is built for        %%%
%%% each aisle. Thus, a perfect context switch is simulated.         %%%
%%% 06/19/2015											      		 %%% 
%%% Siddharth Advani										      	 %%%
%%%																	 %%%		
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%																	 %%% 		
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [accuracy, k, temporal_context_score] = simulateViCoNetWeightIdeal(params)
